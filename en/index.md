...
- [ActiveRecord](active-record.md#activerecord) - [Adavantages of the ActiveRecord](active-record.md#ventajas-del-activerecord) - [Create a model in Kumbia PHP Framework](active-record.md#crear-un-modelo-activerecord-en-kumbiaphp-framework) - [Columns y Attributes](active-record.md#columnas-y-atributos) - [Primary keys and the use of IDs](active-record.md#llaves-primarias-y-el-uso-de-ids) - [Conventions in ActiveRecord](active-record.md#convenciones-en-activerecord) - [ActiveRecord API](active-record.md#activerecord-api) - [Querys](active-record.md#consultas) - [distinct ()](active-record.md#distinct-) - [find_all_by_sql (string $sql)](active-record.md#find_all_by_sql-string-sql) - [find_by_sql (string $sql)](active-record.md#find_by_sql-string-sql) - [find_first (string $sql)](active-record.md#find_first-string-sql) - [find ()](active-record.md#find) - [select_one(string $select_query)](active-record.md#select_one-string-select_query) - [select_one(string $select_query) (static)](active-record.md#select_one-string-select_query-static) - [exists()](active-record.md#exists) - [find_all_by()](active-record.md#find_all_by) - [find_by_*campo*()](active-record.md#find_by_campo) - [find_all_by_*campo*()](active-record.md#find_all_by_campo) - [Counts y summations](active-record.md#conteos-y-sumatorias) - [count()](active-record.md#count) - [sum()](active-record.md#sum) - [count_by_sql()](active-record.md#count_by_sql) - [Averages, maximum and minimum](active-record.md#promedios-máximo-y-mínimo) - [average()](active-record.md#average) - [maximum()](active-record.md#maximum) - [minimum()](active-record.md#minimum) - [Create, update and detelete of records](active-record.md#creación-actualización-y-borrado-de-registros) - [create()](active-record.md#create) - [save()](active-record.md#save) - [update()](active-record.md#update) - [update_all()](active-record.md#update_all) - [delete()](active-record.md#delete) - [delete_all()](active-record.md#delete_all) - [Validations](active-record.md#validaciones) - [validates_presence_of()](active-record.md#validates_presence_of) - [validates_length_of()](active-record.md#validates_length_of) - [validates_numericality_of()](active-record.md#validates_numericality_of) - [validates_email_in()](active-record.md#validates_email_in) - [validates_uniqueness_of()](active-record.md#validates_uniqueness_of) - [validates_date_in()](active-record.md#validates_date_in) - [validates_format_of()](active-record.md#validates_format_of) - [Transacctions](active-record.md#transacciones) - [commit()](active-record.md#commit) - [begin()](active-record.md#begin) - [rollback()](active-record.md#rollback) - [Others methods](active-record.md#otros-métodos)  
  - [sql](active-record.md#sql-string-sql) - [Callbacks](active-record.md#callbacks)  
  - [before_validation](active-record.md#before_validation) - [before_validation_on_create](active-record.md#before_validation_on_create) - [before_validation_on_update](active-record.md#before_validation_on_update) - [after_validation_on_create](active-record.md#after_validation_on_create) - [after_validation_on_update](active-record.md#after_validation_on_update) - [after_validation](active-record.md#after_validation) - [before_save](active-record.md#before_save) - [before_update](active-record.md#before_update) - [before_create](active-record.md#before_create) - [after_update](active-record.md#after_update) - [after_create](active-record.md#after_create) - [after_save](active-record.md#after_save) - [before_delete](active-record.md#before_delete) - [after_delete](active-record.md#after_delete) - [Asociations](active-record.md#asociaciones)  
  - [Belongs (belongs_to)](active-record.md#pertenece-belongs_to) - [Has one (has_one)](active-record.md#tiene-un-has_one) - [Has many (has_many)](active-record.md#tiene-muchos-has_many) - [It has and belongs to many (has_and_belongs_to_many)](active-record.md#tiene-y-pertenece-a-muchos-has_and_belongs_to_many) - [Pagers](active-record.md#paginadores) - [paginate()](active-record.md#paginate) - [paginate_by_sql()](active-record.md#paginate_by_sql) - [Paging in ActiveRecord](active-record.md#paginando-en-activerecord) - [Complete example of pager usage](active-record.md#ejemplo-completo-de-uso-del-paginador) 
- [Parent classes](parent-class.md#clases-padre) 
  - [AppController](parent-class.md#appcontroller) 
  - [View](parent-class.md#view)
- [Libs of KumbiaPHP](parent-class.md#libs-de-kumbiaphp) 
  ...
  - [Auth2](parent-class.md#auth2) 
    - [Requesting an adapter](parent-class.md#solicitando-un-adaptador)
    - [Default adapter](parent-class.md#adaptador-predeterminado)
    - [How authentication works](parent-class.md#como-trabaja-la-autenticacion)
    - [Adapter Model](parent-class.md#adaptador-model) 
      ...
      - [Get the fields loaded on session](parent-class.md#obtener-los-campos-cargados-en-sesion)
      - [Example](parent-class.md#ejemplo)
- [The console](console.md#la-consola) 
  - [Introduction](console.md#introduccion)
...
- [Appendices](appendix.md#apendices) 
  ...
  - [Partials of paging](appendix.md#partials-de-paginacion) 
    ...
    - [Example of use](appendix.md#ejemplo-de-uso)
  - [Auth](appendix.md#auth)
  - [Beta1 to Beta2](appendix.md#beta1-a-beta2)
  - [Deprecated](appendix.md#deprecated)
  - [Methods and classes that were used in previous versions and still work](appendix.md#metodos-y-clases-que-se-usaban-en-versiones-anteriores-y-que-aun) 
    - [List of changes between versions: If don't specify beta1 is that it is compatible in both cases](appendix.md#lista-de-cambios-entre-versiones:-si-no-se-especifica-beta1-es-que-es)
    - [Change on routes between versions:](appendix.md#cambio-en-las-rutas-entre-versiones:)
